...
class SettingsForm(forms.Form):
    ...
    user = None
    email_notifications = forms.ChoiceField(label="E-mail Notifications", choices=(('never', _('Never (disabled)')),('True', _('As-it-happens'))) + notification_types, required=False)
    notifications_for_modules = forms.MultipleChoiceField(label="Receive notifications for modules", required=False)
