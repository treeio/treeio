...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('identities_contacttype_fields', (
            ...
            ('contacttype', models.ForeignKey(orm['identities.contacttype'], null=False)),
            ('contactfield', models.ForeignKey(orm['identities.contactfield'], null=False))
        ))
        db.create_unique('identities_contacttype_fields', ['contacttype_id', 'contactfield_id'])

        # Adding model 'Contact'
        db.create_table('identities_contact', (
            ('object_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['core.Object'], unique=True, primary_key=True)),
            ('contact_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['identities.ContactType'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=256)),
            ('parent', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='child_set', null=True, to=orm['identities.Contact'])),
            ('related_user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.User'], null=True, blank=True)),
            ('related_group', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Group'], null=True, blank=True)),
        ))
        ...
        db.create_table('identities_contactvalue', (
            ...
            ('field', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['identities.ContactField'])),
