            ...
            for key in request.POST:
                if 'mass-contact' in key:
                    try:
                        ...
                        form = MassActionForm(request.user.get_profile(), request.POST, instance=contact)
...
def type_view(request, type_id, response_format='html'):
    ...
    contacts = Object.filter_by_request(request, Contact.objects.filter(contact_type=contact_type))
