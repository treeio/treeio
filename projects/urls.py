...
urlpatterns = patterns('treeio.projects.views',
        ...
        url(r'^task/owned(\.(?P<response_format>\w+))?/?$', 'index_owned', name='projects_index_owned'),
        ...
        # Projects
        url(r'^add(\.(?P<response_format>\w+))?/?$', 'project_add', name='project_add'),
        ...
        # Tasks      
        url(r'^task/add(\.(?P<response_format>\w+))?/?$', 'task_add', name='projects_task_add'),      
