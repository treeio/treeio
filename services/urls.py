...
urlpatterns = patterns('treeio.services.views',
        ...
        url(r'^index(\.(?P<response_format>\w+))?/?$', 'index', name='services_index'),
        url(r'^owned(\.(?P<response_format>\w+))?/?$', 'index_owned', name='services_index_owned'),
        url(r'^assigned(\.(?P<response_format>\w+))?/?$', 'index_assigned', name='services_index_assigned'),
        ...
        url(r'^status/add(\.(?P<response_format>\w+))?/?$', 'status_add', name='services_status_add'),
        ...
        url(r'^queue/add(\.(?P<response_format>\w+))?/?$', 'queue_add', name='services_queue_add'),
        ...
        url(r'^ticket/add(\.(?P<response_format>\w+))?/?$', 'ticket_add', name='services_ticket_add'),
        ...
        url(r'^service/add(\.(?P<response_format>\w+))?/?$', 'service_add', name='services_service_add'),
        
        # SLAs
        url(r'^sla/add(\.(?P<response_format>\w+))?/?$', 'sla_add', name='services_sla_add'),
        url(r'^sla(\.(?P<response_format>\w+))?/?$', 'sla_index', name='services_sla_index'),
        ...
        # Agents
        url(r'^agent(\.(?P<response_format>\w+))?/?$', 'agent_index', name='services_agent_index'),
        ...
        url(r'^agent/add(\.(?P<response_format>\w+))?/?$', 'agent_add', name='services_agent_add'),
        
        # Widgets
        url(r'^widget/index(\.(?P<response_format>\w+))?/?$', 'widget_index', name='services_widget_index'),
