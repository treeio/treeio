...
class KnowledgeFolderForm(ModelForm):
    ...
    def __init__(self, user, knowledgeType_id, *args, **kwargs):
        ...
        self.fields['parent'].queryset = Object.filter_permitted(user, KnowledgeFolder.objects, mode='x')
        if knowledgeType_id:
...
class KnowledgeItemForm(ModelForm):
    ...
    def __init__(self, user, knowledgeType_id, *args, **kwargs):
        ...
        self.fields['folder'].widget.attrs.update({'popuplink': reverse('knowledge_folder_add')})
        if knowledgeType_id:
            self.fields['folder'].initial = knowledgeType_id 
    
        self.fields['category'].label = _("Category")
        self.fields['category'].queryset = Object.filter_permitted(user, KnowledgeCategory.objects, mode='x')
        self.fields['category'].widget.attrs.update({'popuplink': reverse('knowledge_category_add')})
