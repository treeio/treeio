...
urlpatterns = patterns('treeio.messaging.views',
        url(r'^(\.(?P<response_format>\w+))?$', 'index', name='messaging'),
        url(r'^index(\.(?P<response_format>\w+))?$', 'index', name='messaging_index'),
        url(r'^sent(\.(?P<response_format>\w+))?/?$', 'index_sent', name='messaging_sent'),
        url(r'^inbox(\.(?P<response_format>\w+))?/?$', 'index_inbox', name='messaging_inbox'),
        url(r'^unread(\.(?P<response_format>\w+))?/?$', 'index_unread', name='messaging_unread'),
