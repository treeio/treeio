...
urlpatterns = patterns('treeio.documents.views',
        url(r'^(\.(?P<response_format>\w+))?$', 'index', name='document'),
        url(r'^index(\.(?P<response_format>\w+))?$', 'index', name='document_index'),
        url(r'^files(\.(?P<response_format>\w+))?/?$', 'index_files', name='index_files'),
        url(r'^documents(\.(?P<response_format>\w+))?/?$', 'index_documents', name='index_documents'),
        url(r'^weblinks(\.(?P<response_format>\w+))?/?$', 'index_weblinks', name='index_weblinks'),
        
        # Folders
        url(r'^folder/add(\.(?P<response_format>\w+))?/?$', 'folder_add', name='documents_folder_add'),
        ...
        # Documents
        url(r'^add(\.(?P<response_format>\w+))?/?$', 'document_add', name='documents_document_add'),
        ...
        # Web Links
        url(r'^weblink/add(\.(?P<response_format>\w+))?/?$', 'weblink_add', name='documents_weblink_add'),
