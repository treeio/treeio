...
urlpatterns = patterns('treeio.changes.views',
        url(r'^(\.(?P<response_format>\w+))?$', 'index', name='changes_index'),
        
        url(r'^owned(\.(?P<response_format>\w+))?$', 'index_owned', name='changes_index_owned'),
        url(r'^resolved(\.(?P<response_format>\w+))?$', 'index_resolved', name='changes_index_resolved'),
        ...
        url(r'^status/add(\.(?P<response_format>\w+))?/?$', 'status_add', name='changes_status_add'),
        ...
        url(r'^set/add(\.(?P<response_format>\w+))?/?$', 'set_add', name='changes_set_add'),
