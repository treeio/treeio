...
class FilterForm(forms.ModelForm):
    ...
    def __init__(self, user, skip=[], *args, **kwargs):
        ...
        if 'status' in skip:
            ...
            self.fields['status'].queryset = Object.filter_permitted(user, ChangeSetStatus.objects)
...
class SettingsForm(forms.Form):
    ...
    default_changeset_status = forms.ModelChoiceField(label='Default Change Set Status', queryset=[])
