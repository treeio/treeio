...
serviceRecordResource = CsrfExemptResource(handler = handlers.ItemServicingHandler, **ad)
...
#Infrastructure
    ...
    url(r'^service_record/(?P<object_ptr>\d+)', serviceRecordResource, name="api_infrastructure_service_records"),
