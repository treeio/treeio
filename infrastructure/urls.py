...
urlpatterns = patterns('treeio.infrastructure.views',
        url(r'^(\.(?P<response_format>\w+))?$', 'index', name='infrastructure'),
        
        url(r'^index(\.(?P<response_format>\w+))?$', 'index', name='infrastructure_index'),
        url(r'^owned(\.(?P<response_format>\w+))?/?$', 'index_owned', name='infrastructure_index_owned'),
        ...
        url(r'^type/add(\.(?P<response_format>\w+))?/?$', 'type_add', name='infrastructure_type_add'),
        ...
        url(r'^field/add(\.(?P<response_format>\w+))?/?$', 'field_add', name='infrastructure_field_add'),
        ...
        url(r'^status/add(\.(?P<response_format>\w+))?/?$', 'status_add', name='infrastructure_status_add'),
        ...
        url(r'^item/add(\.(?P<response_format>\w+))?/?$', 'item_add', name='infrastructure_item_add'),
        ...
        url(r'^location/add(\.(?P<response_format>\w+))?/?$', 'location_add', name='infrastructure_location_add'),    
