...
//		this.element.find( ".module-top-menu-inline" )
	//		.wrap('<ul data-theme="d" data-inset="true" data-role="listview" class="ui-listview ui-listview-inset ui-corner-all ui-controlgroup ui-controlgroup-vertical ui-shadow" role="listbox" />');
		...
		this.element.find( ".sidebar-link" )
			.buttonMarkup();
			
		this.element.find( ".module-sidebar" )
			.attr("valign", "top")
			
		this.element.find( ".module-content" )
			.attr("valign", "top")
			
		this.element.find( ".module-sidebar-right" )
			.attr("style", "display:none");
			
		this.element.find( ".title" )
			.attr("style", "display:none")
			
		this.element.find( ".subtitle-block" )
			.attr("style", "display:none")
			
		this.element.find( ".sidebar-header" )
			.attr("style", "display:none")
		
		this.element.find( ".help-block-link" )
			.attr("style", "display:none")	
		
		this.element.find( ".mass-form" )
			.attr("style", "display:none")
			
		this.element.find( ".group-link" )
			.attr("style", "display:none")
			
		this.element.find( ".author-link" )
			.attr("style", "display:none")
			
		this.element.find( ".group-control" )
			.attr("style", "display:none")
			
		this.element.find('[data-role="collapsible"]')
			.attr("data-theme", "a")
