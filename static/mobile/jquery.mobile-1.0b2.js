	...
	$.mobile._registerInternalEvents = function(){
		...
		$( document ).bind( "click", function( event ) {
			...
			var baseUrl = getClosestBaseUrl( $link ),
				...
				href = path.makeUrlAbsolute( '/m' + $link.attr( "href" ) || "#", baseUrl ); //tree.io
...
// ^^^^^^^^^^^^^^^^^ TREE.IO ^^^^^^^^^^^^^^^^^^^^^^
		...
		$( e.target ).find( ".top-menu" )
			.buttonMarkup();
		
		$( e.target ).find( ".sidebar-link" )
			.buttonMarkup();
			
		$( e.target ).find( ".module-sidebar" )
			.attr("valign", "top")
			
		$( e.target ).find( ".module-content" )
			.attr("valign", "top")
			
		$( e.target ).find( ".module-sidebar-right" )
			.attr("style", "display:none");
			
		$( e.target ).find( ".title" )
			.attr("style", "display:none")
			
		$( e.target ).find( ".subtitle-block" )
			.attr("style", "display:none")
			
		$( e.target ).find( ".sidebar-header" )
			.attr("style", "display:none")
		
		$( e.target ).find( ".help-block-link" )
			.attr("style", "display:none")	
		
		$( e.target ).find( ".mass-form" )
			.attr("style", "display:none")
			
		$( e.target ).find( ".group-link" )
			.attr("style", "display:none")
			
		$( e.target ).find( ".author-link" )
			.attr("style", "display:none")
			
		$( e.target ).find( ".group-control" )
			.attr("style", "display:none")
			
		$( e.target ).find('[data-role="collapsible"]')
			.attr("data-theme", "a")
