...
qq.FileUploader = function(o){
    ...
    qq.extend(this._options, {
        ...
        template: '<span class="qq-uploader">' +
                //'<div class="qq-upload-drop-area"><span>' + o.text.drop + '</span></div>' +
                '<span class="qq-upload-button">' + o.text.attach + '</span>' +
        ...
        fileTemplate: '<li>' +
                ...
                '<a class="qq-upload-cancel" href="#">' + o.text.cancel + '</a>' +
                '<span class="qq-upload-failed-text">' + o.text.failed + '</span>' +
            '</li>',        
...
qq.extend(qq.UploadHandlerForm.prototype, {
    ...
    _getIframeContentJSON: function(iframe){
        ...
        htmlNode.innerHTML = doc.body.innerHTML;
        var responseText;
        if (htmlNode.innerText) {
            responseText = htmlNode.innerText; // IE
        }
        responseText = htmlNode.textContent; // FF
