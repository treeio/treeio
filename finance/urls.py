...
urlpatterns = patterns('treeio.finance.views',
        url(r'^(\.(?P<response_format>\w+))?$', 'index_transactions', name='finance'),
        
        url(r'^index(\.(?P<response_format>\w+))?$', 
            'index_transactions', name='finance_index_transactions'),
        url(r'^categories(\.(?P<response_format>\w+))?/?$', 'index_categories', name='finance_categories'),
        url(r'^income(\.(?P<response_format>\w+))?/?$', 'income_view', name='finance_income_view'),
        url(r'^balance(\.(?P<response_format>\w+))?/?$', 'balance_sheet', name='finance_balance_sheet'),

        # Accounts
        url(r'^accounts(\.(?P<response_format>\w+))?/?$', 'index_accounts', name='finance_index_accounts'),
        url(r'^account/add(\.(?P<response_format>\w+))?/?$', 'account_add', name='finance_account_add'),
        ...
        # Assets
        url(r'^assets(\.(?P<response_format>\w+))?/?$', 'index_assets', name='finance_index_assets'),
        url(r'^asset/add(\.(?P<response_format>\w+))?/?$', 'asset_add', name='finance_asset_add'),
        ...
        # Equities
        url(r'^equities(\.(?P<response_format>\w+))?/?$', 'index_equities', name='finance_index_equities'),
        url(r'^equity/add(\.(?P<response_format>\w+))?/?$', 'equity_add', name='finance_equity_add'),
        ...
        # Categories
        url(r'^category/add(\.(?P<response_format>\w+))?/?$', 'category_add', name='finance_category_add'),
