                ...
                if i:
                    ...
                    for choice in choices:
                        if choice[0] == i:
                            ...
                            break
                    widgets.append(HiddenInput(attrs=dict(attrs, label=initial_label)))
    ...
    for key in context:
        if isinstance(context[key], BaseForm):
            ...
            for fname in form.fields:
                if not "autocomplete" in fname: # skip newly added fields to avoid looping infinitely
                    ...
                    try:
                        ...
                        if field.widget.attrs and 'callback' in field.widget.attrs and 'autocomplete' in field.widget.attrs['class']:
                            ...
                            # if the field has choices replace value with it's actual label
                            ...
                            form.fields.update({fname: field, "autocomplete_" + fname: new_field})
                            if fname in form.errors:
                                form.errors["autocomplete_"+fname] = form.errors[fname]
                ...
                if not "autocomplete" in fname: # skip newly added fields to avoid looping infinitely
                    ...
                    try:
                        ...
                        if field.widget.attrs and 'callback' in field.widget.attrs and 'multicomplete' in field.widget.attrs['class']:
                            ...
                            # update fields in context
                            form.fields.update({fname: hidden_field, "multicomplete_" + fname: new_field})
                            if fname in form.errors:
                                form.errors["multicomplete_" + fname] = form.errors[fname]
                                del form.errors[fname]
