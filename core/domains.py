...
def setup_domain(domain):
    ...
    box['WHOOSH_INDEX'] = getattr(settings, 'WHOOSH_INDEX', '/srv/vhosts/treeio.com/subdomains/seed/treeio/storage/search').replace(word, domain)
    
    box['WKPATH'] = getattr(settings, 'WKPATH', '/srv/vhosts/treeio.com/treeio/bin/wkhtmltopdf').replace(word, domain)
    box['WKCWD'] = getattr(settings, 'WKCWD', '/srv/vhosts/treeio.com/subdomains/seed/treeio/').replace(word, domain)
