...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('core_group', (
            ...
            ('parent', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='child_set', null=True, to=orm['core.Group'])),
        ...
        db.create_table('core_user', (
            ...
            ('default_group', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='default_user_set', null=True, to=orm['core.Group'])),
            ('last_updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        ...
        db.create_table('core_object', (
            ...
            ('object_name', self.gf('django.db.models.fields.CharField')(max_length=512, null=True, blank=True)),
            ...
            ('user_read', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('user_write', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('user_execute', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('group_read', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('group_write', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('group_execute', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('everybody_read', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('everybody_write', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('everybody_execute', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('last_updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('date_created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
            ('nuvius_resource', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        ...
        db.create_unique('core_object_links', ['from_object_id', 'to_object_id'])
        ...
        db.create_table('core_module', (
            ...
            ('system', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        ...
        db.create_table('core_perspective_modules', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('perspective', models.ForeignKey(orm['core.perspective'], null=False)),
            ('module', models.ForeignKey(orm['core.module'], null=False))
        ))
        db.create_unique('core_perspective_modules', ['perspective_id', 'module_id'])
        ...
        db.create_table('core_modulesetting', (
            ...
            ('perspective', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Perspective'], null=True, blank=True)),
            ('module', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Module'], null=True, blank=True)),
        ...
        db.create_table('core_location', (
            ('object_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['core.Object'], unique=True, primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=512)),
            ('parent', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='child_set', null=True, to=orm['core.Location'])),
        ))
        ...
        db.create_table('core_page', (
            ...
            ('name', self.gf('django.db.models.fields.CharField')(max_length=256)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=256)),
            ('folder', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.PageFolder'])),
        ...
        db.create_table('core_notification', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.User'])),
            ('sender', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='notification_sent_set', null=True, to=orm['core.User'])),
        ...
        db.create_table('core_widget', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.User'])),
            ('perspective', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Perspective'])),
            ('module_name', self.gf('django.db.models.fields.CharField')(max_length=256)),
            ('widget_name', self.gf('django.db.models.fields.CharField')(max_length=256)),
