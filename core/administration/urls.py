...
urlpatterns = patterns('treeio.core.administration.views',
        url(r'^(\.(?P<response_format>\w+))?$', 'index_perspectives', name='core_admin'),
        ...
        # Users
        url(r'^users(\.(?P<response_format>\w+))?/?$', 'index_users', name='core_admin_index_users'),
        ...
        url(r'^user/add(\.(?P<response_format>\w+))?/?$', 'user_add', name='core_admin_user_add'),
        url(r'^user/invite(\.(?P<response_format>\w+))?/?$', 'user_invite', name='core_admin_user_invite'),

        url(r'^contact/setup(\.(?P<response_format>\w+))?/?$', 'contact_setup', name='core_admin_contact_setup'),
        
        # Groups
        url(r'^groups(\.(?P<response_format>\w+))?/?$', 'index_groups', name='core_admin_index_groups'),
        ...
        url(r'^group/add(\.(?P<response_format>\w+))?/?$', 'group_add', name='core_admin_group_add'),

        # Pages
        url(r'^pages(\.(?P<response_format>\w+))?/?$', 'index_pages', name='core_admin_index_pages'),
        url(r'^page/add(\.(?P<response_format>\w+))?/?$', 'page_add', name='core_admin_page_add'),
        ...
        # Setup
        url(r'^setup(\.(?P<response_format>\w+))?/?$', 'setup', name='core_setup'),
        
        # Settings                
        url(r'^settings/edit(\.(?P<response_format>\w+))?/?$', 'settings_edit', name='core_settings_edit'),
        url(r'^settings/view(\.(?P<response_format>\w+))?/?$', 'settings_view', name='core_settings_view'),
